...
import { BACKSTAGE_SUPPORT_EMAIL } from '@/helpers/constants/common.constant'
        ...
        <div className="flex justify-center flex-col items-center container ">
          ...
          <div className="flex w-full py-12 gap-12 max-tablet:flex-col">
            <div className="basis-1/3 ">
              ...
              <Typography className="!text-background mt-2 text-sm">
                {t('footer.delivering-an-exceptional')}
              </Typography>
            </div>
            ...
            <div className="flex gap-2 flex-col max-large-mobile:justify-center">
              ...
              <div className="group">
                <Typography className="!text-background">
                  ...
                  <a
                    href={`mailto:${BACKSTAGE_SUPPORT_EMAIL}`}
                    className="group-hover:underline cursor-pointer"
                  >
                    {BACKSTAGE_SUPPORT_EMAIL}
                  </a>
                </Typography>
              </div>
            </div>
      ...
      {isJackPot && (
        <div className="fixed z-20 right-8 bottom-50 cursor-pointer">
          <div className="relative">
            ...
            <div onClick={handleRedirectBackstage}>
      ...
      {isGiftCode && (
        <div className="fixed z-20 right-10 bottom-80 cursor-pointer">
          <div className="relative">
            ...
            <div className="w-18 h-5" onClick={handleRedirectBackstage}>
